...
const Testimonial = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editMode) {
                await axios.put(`https://artisticify-backend.vercel.app/api/testimonials/updateTestimonial/${editingId}`, data);
            } else {
                await axios.post('https://artisticify-backend.vercel.app/api/testimonials/addTestimonial', data);
            }
            fetchTestimonials();
            resetForm();
        } catch (error) {
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://artisticify-backend.vercel.app/api/testimonials/deleteTestimonial/${id}`);
            fetchTestimonials();
        } catch (error) {
